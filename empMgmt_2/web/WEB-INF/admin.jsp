...
<body>
    ...
    <form method="post" action="admin" name="logout">
	...
	<form method="post" action="handleEmployee" name="handleEmployee">
		<br>
	...
	<form method="post" action="handleEmployee" name="deleteEmployee">
