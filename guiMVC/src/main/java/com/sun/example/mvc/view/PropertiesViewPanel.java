...
public class PropertiesViewPanel extends AbstractViewPanel
{
    ...
    private void initComponents() {
        ...
        propertiesViewTabbedPane.setFont(new Font("Dialog", 0, 11));
        ...
        widthTextField.setFont(new Font("Dialog", 0, 11));
        ...
        heightTextField.setFont(new Font("Dialog", 0, 11));
        ...
        nameLabel.setFont(new Font("Dialog", 0, 11));
        nameLabel.setText("Name:");

        widthLabel.setFont(new Font("Dialog", 0, 11));
        widthLabel.setText("Width:");

        heightLabel.setFont(new Font("Dialog", 0, 11));
        ...
        xPositionTextField.setFont(new Font("Dialog", 0, 11));
        ...
        yPositionTextField.setFont(new Font("Dialog", 0, 11));
        ...
        rotationSpinner.setFont(new Font("Dialog", 0, 11));
        ...
        opacitySpinner.setFont(new Font("Dialog", 0, 11));
        ...
        xPositionLabel.setFont(new Font("Dialog", 0, 11));
        xPositionLabel.setText("X Position:");

        yPositionLabel.setFont(new Font("Dialog", 0, 11));
        yPositionLabel.setText("Y Position:");

        rotationLabel.setFont(new Font("Dialog", 0, 11));
        rotationLabel.setText("Rotation:");

        opacityLabel.setFont(new Font("Dialog", 0, 11));
        opacityLabel.setText("Opacity:");

        changeFontButton.setFont(new Font("Dialog", 0, 11));
        ...
        font.setFont(new Font("Dialog", 0, 11));
        font.setText("Arial Bold 12");

        fontLabel.setFont(new Font("Dialog", 0, 11));
        fontLabel.setText("Font:");

        textLabel.setFont(new Font("Dialog", 0, 11));
        textLabel.setText("Text:");

        text.setColumns(20);
        text.setFont(new Font("DialogInput", 0, 13));
        text.setRows(5);
