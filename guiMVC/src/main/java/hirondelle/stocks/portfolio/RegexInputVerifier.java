...
/**
* Verifies user input into a {@link JTextComponent} versus a
* regular expression.
* 
*<P> This class is likely useful for a wide number of simple input needs.
* See the {@link Pattern} class for details regarding regular
* expressions.
*
...
* class is to be passed to {@link JComponent#setInputVerifier}.
*
