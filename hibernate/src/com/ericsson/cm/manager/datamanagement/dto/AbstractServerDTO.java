...
public abstract class AbstractServerDTO<T extends AbstractServerDTO<T>> extends VersionedEntity {
	...
	public AbstractServerDTO(String description, String name, String ip,
			String hostName, Long port, Boolean reserved, String ownerGroup,
			ServerGroupDTO serverGroupDTO,
			List<ProvisionServerDTO<T>> provisionServerDTOs, String instanceInfo) {
		this(description, name, ip, hostName, port, reserved, ownerGroup, serverGroupDTO, provisionServerDTOs);
		this.instanceInfo = instanceInfo;
	}

	public AbstractServerDTO(String description, String name,
			String ip, String hostName, Long port, Boolean reserved,
	...
	public AbstractServerDTO(String description, String name, String ip,
			String hostName, Long port, Boolean reserved, String ownerGroup,
			ServerGroupDTO serverGroupDTO, List<ProvisionServerDTO<T>> provisionServerDTOs) {
	...
	public void setProvisionServerDTOs(
			List<ProvisionServerDTO<T>> provisionServerDTOs) {
		this.provisionServerDTOs = provisionServerDTOs;
	}
