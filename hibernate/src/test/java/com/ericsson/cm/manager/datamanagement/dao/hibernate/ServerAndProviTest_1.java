...
public class ServerAndProviTest_1 {
	...
	public static void oneTimeSetUp() {
		...
		FEServerDTO feServerDTO = new FEServerDTO("fDesc", "fName", "10.10.10.10", "fHName", 8090l, false, "fow",serverGroupDTO);
		feServerDTO.setProvisionServerDTOs(new ArrayList<ProvisionServerDTO>());
		
		OnlineServerDTO onlineServerDTO = new OnlineServerDTO("oDesc", "oName", "10.10.10.10", "oHName", 8080l, false, "oow", serverGroupDTO);
