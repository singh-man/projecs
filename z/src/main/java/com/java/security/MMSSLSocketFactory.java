...
public class MMSSLSocketFactory extends SSLSocketFactory {
	...
	public static SocketFactory getDefault() {
		System.out.println("SSL Socket factory");
		return new MMSSLSocketFactory();
	}

	public MMSSLSocketFactory() {
		try {
			SSLContext ctx = SSLContext.getInstance("SSL");
			ctx.init(null, new TrustManager[] { new SSLByPassTrustmanager() },
					new SecureRandom());
	...
	class SSLByPassTrustmanager implements X509TrustManager {
